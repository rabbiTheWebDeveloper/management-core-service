...
const initiatePayment = (payload, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (studentSemesterPayment.paymentStatus === client_1.PaymentStatus.PARTIAL_PAID && payload.paymentType !== 'FULL') {
...
const completePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!paymentDetails) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Payment details not foundd!");
    }
    ...
    if (!studentSemesterPayment) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Payment info not found");
    }
